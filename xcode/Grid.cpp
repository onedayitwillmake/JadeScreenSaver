...
GridPoint* Grid::getGridPointNeighbor( GridPoint* point, DIRECTION offset ) {
...
ci::Vec2i Grid::getDirectionalOffset( DIRECTION cardinalDirection ) {
	ci::Vec2i offset = ci::Vec2i::zero();

	switch (cardinalDirection) {
		case DIRECTION::NORTH:		offset = ci::Vec2i( 0, -2); break;
		case DIRECTION::NORTH_EAST: offset = ci::Vec2i( 1, -1); break;
		case DIRECTION::SOUTH_EAST:	offset = ci::Vec2i( 1, 1); break;
		case DIRECTION::SOUTH:		offset = ci::Vec2i( 0, 2); break;
		case DIRECTION::SOUTH_WEST:	offset = ci::Vec2i(-1, 1); break;
		case DIRECTION::NORTH_WEST: offset = ci::Vec2i(-1, -1); break;
		default:
			break;
	}
